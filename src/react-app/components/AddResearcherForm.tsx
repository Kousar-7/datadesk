...
export default function AddResearcherForm({ onSubmit, loading }: AddResearcherFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="research_papers_count" className="block text-sm font-medium text-gray-700 mb-2">
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white py-2 px-4 rounded-lg transition-colors duration-200 font-medium"
        >
